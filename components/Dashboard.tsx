    ...
    <div className="p-4 space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-white/5 border border-white/10 p-4 rounded-xl">
          ...
          <p className="text-[11px] font-bold text-slate-400 uppercase leading-tight mt-1">Vencimientos<br />(30 días)</p>
        </div>
        <div className="bg-white/5 border border-white/10 p-4 rounded-xl">
          ...
          <p className="text-[11px] font-bold text-slate-400 uppercase leading-tight mt-1">Equipos<br />Pendientes</p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between px-1">
          <h3 className="text-xs font-black uppercase tracking-widest text-slate-500">Ubicaciones Recientes</h3>
